...
//  String memoryButtonText[] = {"MC", "MR", "MS", "M+"};
  ...
  MyOpenCloseButton memoryButton[] = new MyOpenCloseButton[memoryButtonText.length];
  ...
  ///////////////////////////
  public MyCalculator(String frameText)//constructor
  {
    super(frameText);
...
// set Co-ordinates for Memory Buttons
    ...
    for (int i = 0; i < memoryButton.length; i++) {
      memoryButton[i] = new MyOpenCloseButton(tempX, y, WIDTH, HEIGHT, memoryButtonText[i], this);
...
class MyOpenCloseButton extends Button implements ActionListener {

  MyCalculator cl;

  /////////////////////////////////
  MyOpenCloseButton(int x, int y, int width, int height, String cap, MyCalculator clc) {
    super(cap);
  ...
  public void actionPerformed(ActionEvent ev) {
    String tempText = ((MyOpenCloseButton) ev.getSource()).getLabel();
...
class MyOperatorButton extends Button implements ActionListener {
  ...
  ///////////////////////
  static String addNewChar(String s, String c) {
...
//    double temp = this.cl.getCalculateService().calculate(cl.displayLabel.getText());
...
//      return;
      String tempLabel = addNewChar(this.cl.displayLabel.getText(), opText);
      this.cl.displayLabel.setText(tempLabel);
      return;
    }
    double temp = this.cl.getCalculateService().calculate(cl.displayLabel.getText());
    cl.displayLabel.setText(MyCalculator
        .getFormattedText(temp));
    cl.setClear = true;
  }//actionPerformed
}//class
